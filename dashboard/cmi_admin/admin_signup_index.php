          ...
          <main class="col-md-9 ms-sm-auto col-xl-10 px-md-4 bg-secondary-subtle">
            <div class="row px-5 pt-3 mt-5">
              ...
              <div class="col-md-2 col-lg-2">
                 <a href="dashboard/cmi_admin/index.php.php" class="btn btn-outline-success float-end" role="button">Back</a>
              </div>
            </div>
                  ...
                  <div class="block text-start">
                    <div class="wrapper">
                      ...
                      <div class="form-group">
                        ...
                        <p>Already have an account? <a href="dashboard/cmi_admin/index.php">Login here</a>.</p>
                      </form>    
                    </div>       
                  </div>
